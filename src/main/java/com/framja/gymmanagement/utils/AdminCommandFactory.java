...
public class AdminCommandFactory implements CommandFactory {
    ...
    public List<MenuOption<?>> createMenuOptions() {
        ...
        return List.of(
                new MenuOption<>(1, "Add Equipment", CommandFactory.create(args -> {
                ...
                new MenuOption<>(2, "Update Equipment", CommandFactory.create(args -> {
                    if (args.length < 1 || !(args[0] instanceof Equipment)) {
                ...
                new MenuOption<>(3, "Remove Equipment", CommandFactory.create(args -> {
                ...
                new MenuOption<>(4, "View All Equipment", CommandFactory.create(args ->
                        new ViewAllEquipmentCommand(equipmentService)
                )),

                // User management
                new MenuOption<>(5, "Add User", CommandFactory.create(args -> {
                ...
                new MenuOption<>(6, "Update Member", CommandFactory.create(args -> {
                ...
                new MenuOption<>(7, "Update Trainer", CommandFactory.create(args -> {
                ...
                new MenuOption<>(8, "Remove User", CommandFactory.create(args -> {
                ...
                new MenuOption<>(9, "Find All Users", CommandFactory.create(args ->
                        new FindAllUsersCommand(userService)
                )),
                new MenuOption<>(10, "Find User By Username", CommandFactory.create(args -> {
                    if (args.length < 1 || !(args[0] instanceof String)) {
                ...
                new MenuOption<>(11, "Get Statistics", CommandFactory.create(args ->
                        new GetStatisticsCommand(equipmentService, userService, courseService)
                )),

                // Course Management
                new MenuOption<>(12, "Create Course", CommandFactory.create(args -> {
                ...
                new MenuOption<>(13, "Read All Courses", CommandFactory.create(args ->
                        new ReadAllCoursesCommand(courseService)
                )),
                new MenuOption<>(14, "Update Course", CommandFactory.create(args -> {
                    if (args.length < 1 || !(args[0] instanceof Course)) {
                ...
                new MenuOption<>(15, "Delete Course", CommandFactory.create(args -> {
                    if (args.length < 1 || !(args[0] instanceof Integer)) {
                ...
                new MenuOption<>(16, "Create GymClass", CommandFactory.create(args -> {
                ...
                new MenuOption<>(17, "View All GymClasses", CommandFactory.create(args ->
                        new ReadGymClassCommand(classService))),
                new MenuOption<>(18, "Update GymClass", CommandFactory.create(args -> {
                ...
                new MenuOption<>(19, "Delete GymClass", CommandFactory.create(args -> {
                    if (args.length < 1 || !(args[0] instanceof Integer)) {
